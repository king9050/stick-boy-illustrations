...
Composition:
{具体画面：小男孩在哪里、正在做什么、主要物件是什么、信息如何流动}
...
```text
Regenerate this illustration with the same core meaning and simple layout, but make the boy more central to the conceptual action. He should be doing the strange work that explains the idea, not standing beside the diagram. Keep it clean, sparse, hand-drawn, and not cute.
```
