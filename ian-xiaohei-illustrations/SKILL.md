...
description: 生成 Ian 风格的多语言正文配图。用于用户要求为中文、英文、日语、韩语、西班牙语等文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“怪诞”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用小男孩 IP、纯白手绘、少量红橙蓝批注、简洁清爽但天马行空的视觉风格。
---
...
为多语言文章设计和生成 16:9 横版正文配图。默认按 300 ppi 输出。支持中文、英文、日语、韩语、西班牙语等语言。目标不是做商业插画、PPT 信息图或可爱卡通，而是把文章里的关键判断、流程、结构、状态或隐喻，变成一张清爽、怪诞、有创意、可读但不说明书的手绘解释图。

默认视觉 IP 是“手绘小男孩”：参考用户提供的头像火柴人气质，黑色蓬松短发、圆脸、点状眼睛、淡淡微笑、浅蓝上衣、深色短裤、细线条四肢，像一个认真参与系统运转的小操作员。小男孩必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaohei-ip.md`：小男孩 IP 的形象、性格、动作库和禁忌。
